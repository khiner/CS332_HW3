...
abstract class BinExpr extends Expr {
     ...
     */
    boolean compileBin(Assembly a, Expr left, Expr right, int pushed, int free) {
     ...
     */
    void compileOp(Assembly a, String op, int pushed, int free) {
     ...
     */
    void compileCommutativeOp(Assembly a, String op, int pushed, int free) {
     ...
     */
    void compileCond(Assembly a, int pushed, int free) {
        if (compileBin(a, left, right, pushed, free)) {
     ...
     *  true case.
     */
    void compileCondValue(Assembly a, String test, int pushed, int free) {
